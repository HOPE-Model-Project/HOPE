...
function create_preprocessing_config_from_hope_settings(hope_config::Dict)::PreprocessingConfig
    ...
    preprocessing_dict = Dict(
        ...
        "time_periods" => get(hope_config, "time_periods", Dict{Int, Tuple{Int,Int,Int,Int}}()),
...
"""
function preprocess_data!(preprocessor::DataPreprocessor, input_data::Dict)
...
"""
function process_generator_aggregation!(preprocessor::DataPreprocessor)
...
"""
function process_time_clustering!(preprocessor::DataPreprocessor)
...
"""
function setup_full_time_structure!(preprocessor::DataPreprocessor)
...
"""
function validate_processed_data!(preprocessor::DataPreprocessor)
...
"""
function print_preprocessing_summary(preprocessor::DataPreprocessor)
...
# Export functions
export PreprocessingConfig, DataPreprocessor
