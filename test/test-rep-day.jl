...
""")
    ...
    rep_kmeans = HOPE.build_endogenous_rep_periods(multi_load, multi_af, ["Z1"], ["G1"], kmeans_multi_config)
    ...
    rep_kmeans_linked = HOPE.build_endogenous_rep_periods(multi_load, multi_af, ["Z1"], ["G1"], kmeans_linked_config)
    ...
    rep_planning_kmeans = HOPE.build_endogenous_rep_periods(planning_load, planning_af, ["Z1"], ["G1", "G2"], planning_kmeans_config; generator_data=planning_generator_df)
    ...
    rep_refine_kmeans = HOPE.build_endogenous_rep_periods(refine_load, refine_af, ["Z1"], ["G1"], refine_kmeans_config; generator_data=refine_generator_df)
